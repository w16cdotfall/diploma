...
<html>
    ...
    <body>
        <h1>Список заявок</h1>
	<input type="button" onclick="window.location.href='index.php'" value="Назад">
<?php
	include_once("db.php");
	$sql = "SELECT `id`, `text_kr`, `type`, `date_end`, `response` FROM `req` WHERE `closed`='closed' ORDER BY `date_end` ASC";
	...
	echo '<td><a title="Восстановить" href="restore.php?id='. $data['id'].'"><img src="images/restore.png" width="40" 
